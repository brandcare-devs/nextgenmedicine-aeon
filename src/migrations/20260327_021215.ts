...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('x', 'facebook', 'linkedin', 'instagram', 'tiktok', 'youtube');
  ...
  CREATE TABLE "press_articles" (
  	...
  	"publication_logo_id" integer NOT NULL,
  ...
  CREATE TABLE "press_articles_locales" (
  	"title" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "header_cta_buttons_locales" (
  	"link_label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "footer" (
  	...
  	"terms_link_type" "enum_footer_terms_link_type" DEFAULT 'reference',
  	"terms_link_new_tab" boolean,
  	"terms_link_url" varchar,
  	"privacy_link_type" "enum_footer_privacy_link_type" DEFAULT 'reference',
  ...
  CREATE TABLE "footer_locales" (
  	"newsletter_heading" varchar DEFAULT 'SIGN-UP FOR UPDATES',
  	"newsletter_placeholder" varchar DEFAULT 'YOUR EMAIL HERE',
  	"cta_link_label" varchar NOT NULL,
  	"terms_link_label" varchar NOT NULL,
  	"privacy_link_label" varchar NOT NULL,
  	"copyright" varchar DEFAULT '© NGM all right reserved 2023.',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "press_articles" ADD CONSTRAINT "press_articles_publication_logo_id_media_id_fk" FOREIGN KEY ("publication_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "press_articles" ADD CONSTRAINT "press_articles_thumbnail_id_media_id_fk" FOREIGN KEY ("thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "press_articles_locales" ADD CONSTRAINT "press_articles_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_articles"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_press_articles_fk" FOREIGN KEY ("press_articles_id") REFERENCES "public"."press_articles"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "header_cta_buttons_locales" ADD CONSTRAINT "header_cta_buttons_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header_cta_buttons"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "press_articles_publication_logo_idx" ON "press_articles" USING btree ("publication_logo_id");
  CREATE INDEX "press_articles_thumbnail_idx" ON "press_articles" USING btree ("thumbnail_id");
  CREATE INDEX "press_articles_updated_at_idx" ON "press_articles" USING btree ("updated_at");
  CREATE INDEX "press_articles_created_at_idx" ON "press_articles" USING btree ("created_at");
  CREATE UNIQUE INDEX "press_articles_locales_locale_parent_id_unique" ON "press_articles_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_press_articles_id_idx" ON "payload_locked_documents_rels" USING btree ("press_articles_id");
  ...
  CREATE UNIQUE INDEX "header_cta_buttons_locales_locale_parent_id_unique" ON "header_cta_buttons_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "press_articles" CASCADE;
  DROP TABLE "press_articles_locales" CASCADE;
  ...
  DROP TABLE "header_cta_buttons_locales" CASCADE;
